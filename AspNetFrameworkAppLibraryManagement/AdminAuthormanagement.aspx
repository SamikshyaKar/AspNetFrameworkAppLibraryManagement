<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AdminAuthormanagement.aspx.cs" Inherits="AspNetFrameworkAppLibraryManagement.AdminAuthormanagement" %>
                ...
                <div class="row">
                    <div class="col-md-4">
                      ...
                      <div class="input-group-text">
                         <asp:TextBox ID ="TextBox1" CssClass="form-control" runat="server" placeholder="Author ID" ></asp:TextBox>
