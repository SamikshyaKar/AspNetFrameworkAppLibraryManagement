<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AdminMemberManagement.aspx.cs" Inherits="AspNetFrameworkAppLibraryManagement.AdminMemberManagement" %>
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           <img width="100" src="Images/Flower3.jpg" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
                     ...
                     <div class="col-md-5">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              ...
                              <asp:LinkButton class="btn btn-danger me-1" ID="LinkButton3" runat="server"><i class="fas fa-times-circle"></i></asp:LinkButton>
                           </div>
                        </div>
                     </div>
                  </div>
