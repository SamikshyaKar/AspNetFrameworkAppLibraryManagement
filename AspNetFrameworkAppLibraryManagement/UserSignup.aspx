<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="UserSignup.aspx.cs" Inherits="AspNetFrameworkAppLibraryManagement.UserSignup" %>
            ...
            <div class="card">
               <div class="card-body">
                  <div class="row">
                     <div class="col">
                        <center>
                           <img width="100" src="Images/Flower8.jpg"/>
                        </center>
                     </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                     <div class="col-8 mx-auto">
                        <center>
                           <div class="form-group">
                              <asp:Button class="btn btn-primary btn-block btn-lg w-100" ID="Button1" runat="server" Text="SignUP" />
                           </div>
                        </center>
                     </div>
                  </div>
